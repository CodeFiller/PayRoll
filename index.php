...
$db=new mysqli('localhost', $user, $pass, $db) or die("unable to connect");
  $query  = mysqli_query($db,"SELECT * from deductions");
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="jumbotron">
        ...
        <p><a data-toggle="modal" class="btn btn-lg btn-success" href="#instructor" role="button">Brought To You By: Anil Kumar</a></p>
      </div>

      <!-- Site footer -->
      <footer class="footer">
        <p align="center">&copy; 2019 PAYROLL MANAGEMENT SYSTEM</p>
        <p align="center">Brought To You By<a target="_blank" href="4mt17cs016">Anil kumar</a></p>
      </footer>
        ...
        <div class="modal-dialog modal-sm">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body" style="padding:40px 50px;">
              <div align="center">
                <a href="4MT17CS016" target="_blank" title="4mt17cs016"><big><b>4MT17CS016</b></big></a>
              </div>
            </div>
          </div>
        </div>
