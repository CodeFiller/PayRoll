<?php
  ...
  $query = mysqli_query($db,"SELECT * from deductions WHERE deduction_id='1'");
                    ...
                    <table class="table table-bordered table-hover table-condensed" id="myTable">
                      ...
                      <tbody>
                        <?php
                          ...
                          $select_db = mysqli_select_db($db,'payroll');
                          if (!$select_db)
                          {
                            die("Database Selection Failed" . mysqli_error());
                          }
                          
                          $query=mysqli_query($db,"select * from employee ORDER BY emp_id asc")or die(mysql_error());
                          while($row=mysqli_fetch_array($query))
                          {
                            $id     =$row['emp_id'];
                            $fname  =$row['fname'];
